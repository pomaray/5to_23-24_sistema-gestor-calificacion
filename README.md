...
¡Bienvenido al Sistema Gestor de Calificaciones desarrollado por estudiantes de quinto año de Informática! Este proyecto representa nuestro esfuerzo colaborativo durante el período escolar 2023-2034. La aplicación está diseñada en C# con un enfoque en Programación Orientada a Objetos y sigue una arquitectura MVC utilizando Windows Forms y Guna Framework para la interfaz de usuario.

## Características Destacadas

- Desarrollado en C# con Programación Orientada a Objetos
- Arquitectura MVC (Modelo-Vista-Controlador)
- Interfaz de Usuario moderna y atractiva gracias a Windows Forms y Guna Framework

## Personalización y Diseño

El diseño de la interfaz de usuario es una parte fundamental de nuestra aplicación. Hemos utilizado Guna Framework para crear una experiencia visualmente atractiva y moderna.
...
[![Contributors](https://img.shields.io/github/contributors/pomaray/5to_23-24_sistema-gestor-calificacion.svg)](https://github.com/pomaray/5to_23-24_sistema-gestor-calificacion/graphs/contributors)
